...
public:
  ...
  ATVDriver() : nh(ros::NodeHandle()), pnh(ros::NodeHandle("~")) {
    ...
    data->motor_params.steering.Min =
        pnh.param<double>("steering_pos_min", -25.0);
    data->motor_params.steering.Max =
        pnh.param<double>("steering_pos_max", 25.0);
    data->motor_params.rear_brake.Min =
        pnh.param<double>("rear_brake_pos_min", 0.0);
    data->motor_params.rear_brake.Max =
        pnh.param<double>("rear_brake_pos_max", 10.0);
    data->motor_params.front_brake.Min =
        pnh.param<double>("front_brake_pos_min", 0.0);
    data->motor_params.front_brake.Max =
        pnh.param<double>("front_brake_pos_max", 10.0);
    data->motor_params.throttle.Min =
        pnh.param<double>("throttle_pos_min", 0.0);
    data->motor_params.throttle.Max =
        pnh.param<double>("throttle_pos_max", 12.0);
    data->motor_params.rear_brake_starting_state_low_rpm =
        pnh.param<double>("rear_brake_starting_state_low_rpm", 100.0);
    data->motor_params.throttle_regular =
        pnh.param<double>("throttle_regular", 5.0);
    ...
    data->target_velocity = new long[4]{3500, 3500, 3500, 3500};
    ...
    pub_action_str =
        nh.advertise<std_msgs::String>("/soma/atv_driver/action_str", 3);
...
private:
  ...
  void callback_cmd_vel(const geometry_msgs::TwistConstPtr &cmd_vel) {
    ...
    data->u_in.phi = data->u_in.phi * 1.8;
    data->u_in.phi =
        std::max(data->u_in.phi, DEG2RAD(data->motor_params.steering.Min));
    data->u_in.phi =
        std::min(data->u_in.phi, DEG2RAD(data->motor_params.steering.Max));
