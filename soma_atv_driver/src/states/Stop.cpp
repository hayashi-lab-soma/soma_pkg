...
int Stop::_Enter(soma_atv_driver::Data_t *data) {
  ...
  data->motors.steer_vel.In = 3500.0;
  data->motors.rear_vel.In = 3500.0;
  data->motors.front_vel.In = 3500.0;
  data->motors.throttle_vel.In = 3500.0;
...
int Stop::_Exit(soma_atv_driver::Data_t *data) { return 0; }