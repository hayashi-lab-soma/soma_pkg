...
parser.add_argument('--test_sv_path', type=str, default="/home/hayashi/catkin_ws/src/soma_pkg/soma_perception/prediction")
parser.add_argument('--checkpoint_path',type=str,default="/home/hayashi/catkin_ws/src/soma_pkg/soma_perception/checkpoints/gscnn_best.pth")
parser.add_argument('-wb', '--wt_bound', type=float, default=1.0)
parser.add_argument('--maxSkip', type=int, default=0)
parser.add_argument('--data-cfg', help='data config (kitti format)',
                    default='/home/hayashi/catkin_ws/src/soma_pkg/soma_perception/scripts/rellis.yaml',
                    type=str)
...
def image_seg(msg):
    ...
    status=cv2.imwrite('/home/hayashi/catkin_ws/src/soma_pkg/soma_perception/scripts/test.jpg', cv2_img)
    ...
    input = Image2.open('./test.jpg').convert('RGB')
    ...
    seg_img = Image2.fromarray(seg_img)
    print(seg_path)
    ...
    if args.viz:
        ...
        edge_img = Image2.fromarray(edge_img)
        ...
        color_label = convert_color(seg_arg,id_color_map)
        color_label = Image2.fromarray(color_label)
        print(color_path)
        color_label.save(os.path.join(color_path,file_name))   

    execute_time= time.time()- start_time
    print("Segmentation time: ", (execute_time)*1000, " ms")
    start_time=0
    execute_time=0
    ...
    # imgmsg = ros_numpy.msgify(Image1, im1, encoding= 'rgb8')
    # pub.publish(imgmsg)
    pub = rospy.Publisher('/Rellis/GSCNN_seg/raw_data', Image1, queue_size=10) #raw segmentation output
...
def main():
    rospy.init_node('rellis_seg',anonymous=True)
    # Define your image topic
    image_topic = "/image_publisher_1639021596108814248/image_raw" #raw img topic
    # Set up your subscriber and define its callback
    rospy.Subscriber(image_topic, Image1, image_seg)
